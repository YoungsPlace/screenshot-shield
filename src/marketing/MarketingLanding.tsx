    ...
    <main className="marketing-shell" id="top">
      <section className="hero-section" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <h1 id="hero-title">Clean screenshots before they leave your browser.</h1>
          <p className="hero-lede">
            Screenshot Shield helps you paste or drop a screenshot, review likely sensitive text, draw
            final redaction boxes, and export a newly rendered file without sending the image to a server.
          </p>
          <div className="hero-actions" aria-label="Primary actions">
            <button type="button" className="primary-cta" onClick={onStartEditing} disabled={!appReady}>
      ...
      <section className="proof-panel" id="privacy-proof" aria-labelledby="privacy-title">
        ...
        <div className="proof-grid">
          <article>
            ...
            <p>Imported images are decoded for editing and are not written to localStorage, IndexedDB, or remote storage by the app.</p>
          </article>
          <article>
            <span className="proof-icon" aria-hidden="true">02</span>
            <h3>Same-origin assets</h3>
            <p>Detection helpers are expected to load from the built site. Manual redaction remains usable if OCR support is unavailable.</p>
          </article>
          <article>
            <span className="proof-icon" aria-hidden="true">03</span>
            <h3>New export bytes</h3>
            <p>Downloads are rendered from a fresh canvas as PNG or JPEG, which avoids reusing the original encoded file and its metadata.</p>
          </article>
        </div>
      </section>
      ...
      <section className="detectors-section" aria-labelledby="detectors-title">
        <div className="section-heading">
          ...
          <p>
            OCR-assisted suggestions focus on patterns commonly leaked in product, support, and engineering
            screenshots. You stay in control of every region before export.
          </p>
        </div>
      ...
      <section className="limitations-section" aria-labelledby="limits-title">
        <div>
          ...
          <h2 id="limits-title">Screenshot Shield reduces sharing risk; it does not replace review.</h2>
        </div>
        <ul className="limits-list">
          <li>Low-contrast, rotated, cropped, or stylized text can evade OCR or pattern checks.</li>
          <li>Faces, diagrams, custom IDs, and visual secrets require manual rectangle redaction.</li>
          <li>Pixelation is only safe when the export renderer applies irreversible blocks to a fresh canvas.</li>
      ...
      <section className="final-cta" aria-labelledby="final-cta-title">
        ...
        <button type="button" className="primary-cta primary-cta--light" onClick={onStartEditing} disabled={!appReady}>
